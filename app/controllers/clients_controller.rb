...
class ClientsController < ApplicationController
  ...
  private
    ...
    def update_client_params
      ...
      :folio_or_parcel_number, :physical_address, :owes_money_interest_in_property, :monthly_cs_bi_weekly_amount, :monthly_cs_bi_weekly_amount,
      :monthly_cs_weekly_amount, :monthly_cs_number_of_months_delinquent_child_support, :monthly_cs_date_of_last_child_support_payment,
      :monthly_cs_amount_of_last_child_support_payment, :monthly_cs_averages_owed_as_of, :monthly_cs_averages_owed, :monthly_alimony_cs_averages_owed_as_of,
