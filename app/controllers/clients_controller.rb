...
class ClientsController < ApplicationController
  ...
  private
    ...
    def update_client_params
      ...
      :work_phone_number, :mailing_date, :dissolution_of_marriage, :circuit, :division, :judge_name, :judge_address,
      :judge_email, :judge_courtroom, :owes_money_drivers_license_number, :owes_money_professional_license, :owes_money_employer_address,
      :owes_money_employer_phone_number, :owes_money_represented_by_council, :owes_money_assets, :owes_money_real_proprty, :legal_description,
      :folio_or_parcel_number, :physical_address, :owes_money_interest_in_property, :monthly_cs_bi_weekly_amount,
      :monthly_cs_weekly_amount, :monthly_cs_number_of_months_delinquent_child_support, :monthly_cs_date_of_last_child_support_payment, :monthly_cs_bi_monthly_amount,
      :monthly_cs_amount_of_last_child_support_payment, :monthly_cs_averages_owed_as_of, :monthly_cs_averages_owed, :monthly_alimony_cs_averages_owed_as_of, :monthly_alimony_bi_weekly_amount,
